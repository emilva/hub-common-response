...
public class VersionBomComponentView extends HubView {
    ...
    public VersionBomComponentView usages(final List<MatchedFileUsageEnum> usages) {
        this.usages = usages;
        return this;
    }

    public VersionBomComponentView addUsagesItem(final MatchedFileUsageEnum usagesItem) {
